...
const Download = () =>
  <div style={{display: 'flex', alignItems: 'center',margin: '50px',flexDirection: 'column'}}>
    ...
    <a href="https://obscure-inlet-34461.herokuapp.com/app_debug.apk" download="app_debug.apk" download><img src="/android3.png" alt="android-logo" width="120" height="120" /></a>
